...
//            简单工厂模式
//        Human whiteHuman1 = HumanFactory.createman(WhiteHuman.class);
//        whiteHuman.getColor();
//        whiteHuman.talk();
////         女娲第二次造人，火候过足，于是黑人产生了
//        System.out.println("\n--造出的第二批人是黑色人种--");
//        Human blackHuman1 =  HumanFactory.createman(BlackHuman.class);
//        blackHuman.getColor();
//        blackHuman.talk();
////         第三次造人，火候刚刚好，于是黄色人种产生了
//        System.out.println("\n--造出的第三批人是黄色人种--");
//        Human yellowHuman1 =  HumanFactory.createman(YellowHuman.class);
//        yellowHuman.getColor();
//        yellowHuman.talk();
